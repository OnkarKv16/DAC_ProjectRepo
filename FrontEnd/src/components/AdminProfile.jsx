...
function AdminProfile() {
    ...
    //     let resp = window.confirm("Are you sure to delete Admin?");
    //     if (resp) {
    //       axios
    ...
    const handleSubmit = (e) => {
        e.preventDefault()      
        axios.put("http://localhost:8080/api/admin", user)
            .then(resp => {
                console.log(resp)
                swal({
                    title: "Success!",
                    ...
                    <div className="card shadow bg-white">
                        <div className="card-body">
                            <form onSubmit={handleSubmit}>
                                ...
                                {/* <button onClick={() => deleteAdmin(user.id)} className="btn btn-primary float-right">Delete Profile</button> */}
