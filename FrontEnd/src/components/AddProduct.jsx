                        ...
                        <div className="col-sm-6">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-group form-row">
                                    ...
                                    <div className="col-sm-8">
                                        <input type="number" name="quantity" value={product.quantity} onChange={handleInput} className="form-control" />
                                        {errors.quantity && <medium className="text-danger float-right">{errors.quantity}</medium>}
                                    </div>
                                </div>
                                <div className="form-group form-row">
